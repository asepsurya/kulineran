...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="/toko/kategoripengeluaran/add" method="post">
                @csrf
                <div class="mb-3">
                    <label for="">Masukan Kategori Pengeluaran</label>
                    <input type="text" name="Kpengeluaran" id="Kpengeluaran" class="form-control" value="{{ old('Kpengeluaran') }}">
                </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/toko/kategoripengeluaran/update" method="post">
                @csrf
