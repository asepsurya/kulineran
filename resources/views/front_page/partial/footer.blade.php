  ...
  <div class="osahan-menu-fotter fixed-bottom bg-white px-3 py-2 text-center d-none">
    <div class="row">
        <div class="col ">
            <a href="/" class="{{ Request::is('/') ? 'text-danger' : 'text-dark'}} small font-weight-bold text-decoration-none">
                <p class="h4 m-0"><i class="feather-home {{ Request::is('/') ? 'text-danger' : ''}}"></i></p>
                Home
            </a>
        </div>
        <div class="col">
            <a href="/search?search=" class="{{ Request::is('search*') ? 'text-danger' : 'text-dark'}} small font-weight-bold text-decoration-none">
                <p class="h4 m-0"><i class="feather-map-pin {{ Request::is('search*') ? 'text-danger' : ''}}"></i></p>
                Trending
            </a>
        </div>
        <div class="col bg-white rounded-circle mt-n4 px-3 py-2">
            <div class="bg-danger rounded-circle mt-n0 shadow">
                <a href="/cart" class="text-white small font-weight-bold text-decoration-none">
                    <i class="feather-shopping-cart "></i>
                </a>
            </div>
        </div>
        <div class="col">
            <a href="/favorites" class="{{ Request::is('favorites') ? 'text-danger' : 'text-dark'}} small font-weight-bold text-decoration-none">
                <p class="h4 m-0"><i class="feather-heart {{ Request::is('favorites') ? 'text-danger' : ''}}"></i></p>
                Favorites
            </a>
        </div>
        <div class="col">
            <a href="/profile" class="{{ Request::is('profile') ? 'text-danger' : 'text-dark'}} small font-weight-bold text-decoration-none">
                <p class="h4 m-0"><i class="feather-user {{ Request::is('profile') ? 'text-danger' : ''}}"></i></p>
                Profile
            </a>
        </div>
    </div>
